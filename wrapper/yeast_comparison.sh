...
# # background forward
# ~/bio-storici/scripts/RibosePreferenceAnalysis/count_background.py ../../genome/saccer2_chrM.fa --mono -s -o strand_split/bg/chrM_mono_forward.raw &
# for dis in $(seq 1 5) 100
# do
#     ~/bio-storici/scripts/RibosePreferenceAnalysis/count_background.py ../../genome/saccer2_chrM.fa -d ${dis} -s -o strand_split/bg/chrM_dinuc_d${dis}_forward.raw &
# done
# ~/bio-storici/scripts/RibosePreferenceAnalysis/count_background.py ../../genome/saccer2_chrM.fa --trinuc -s -o strand_split/bg/chrM_trinuc_forward.raw &


# # background reverse
# ~/bio-storici/scripts/RibosePreferenceAnalysis/count_background.py ../../genome/saccer2_chrM_rc.fa --mono -s -o strand_split/bg/chrM_mono_reverse.raw &

# for dis in $(seq 1 5) 100
# do
#     ~/bio-storici/scripts/RibosePreferenceAnalysis/count_background.py ../../genome/saccer2_chrM_rc.fa -d ${dis} -s -o strand_split/bg/chrM_dinuc_d${dis}_reverse.raw &
# done
# ~/bio-storici/scripts/RibosePreferenceAnalysis/count_background.py ../../genome/saccer2_chrM_rc.fa --trinuc -s -o strand_split/bg/chrM_trinuc_reverse.raw &
# wait

# # count individual
# for file in $(ls bed_separated)
# do
#     ~/bio-storici/scripts/RibosePreferenceAnalysis/count_rNMP.py ../../genome/saccer2_chrM.fa bed_separated/$file -m -d --dist 1 2 3 4 5 100 -t -o strand_split/individual/chrM &
# done
# wait
...
# # resort
# ls strand_split/normalized | xargs -I aa -P 8 ~/bio-storici/scripts/RibosePreferenceAnalysis/resort.py strand_split/normalized/aa ./order_mito.tsv -c 2 -o strand_split/tsv/aa.tsv
...
# for st in forward reverse
# do
#     ~/bio-storici/scripts/rNMP_hmt_analysis/heatmap_barplot/generate_bar_plot.py strand_split/tsv/chrM_mono_${st}.tsv -o strand_split/plots/chrM_barplot_normalized_${st}.png &
...
#     ~/bio-storici/scripts/RibosePreferenceAnalysis/resort.py strand_split/normalized/chrM_sum1_${st}.norm ./order_mito.tsv -c 2 -o strand_split/tsv/chrM_mono_sum1_${st}.tsv
#     ~/bio-storici/scripts/rNMP_hmt_analysis/heatmap_barplot/generate_bar_plot.py strand_split/tsv/chrM_mono_sum1_${st}.tsv -o strand_split/plots/chrM_barplot_raw_${st}.png &
# done
# wait

# # draw barplot light/heavy comparison
# ls strand_split/raw | grep mono| xargs -I aa -P 2 ~/bio-storici/scripts/RibosePreferenceAnalysis/resort.py strand_split/raw/aa ./order_mito.tsv -c 2 -o strand_split/tsv/aa.tsv
# rename 's/.raw.tsv/_raw.tsv/' strand_split/tsv/* -f
~/bio-storici/scripts/rNMP_hmt_analysis/heatmap_barplot/strand_split_plot.py strand_split/tsv/chrM_mono_forward_raw.tsv strand_split/tsv/chrM_mono_reverse_raw.tsv -o strand_split/plots/chrM_count.png --no_annot
~/bio-storici/scripts/rNMP_hmt_analysis/heatmap_barplot/strand_split_plot.py strand_split/tsv/chrM_mono_forward_raw.tsv strand_split/tsv/chrM_mono_reverse_raw.tsv -o strand_split/plots/chrM_count_annotated.png
